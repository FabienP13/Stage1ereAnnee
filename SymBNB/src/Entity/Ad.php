 ...
 * @UniqueEntity(
 * fields={"title"},
 * message="Une autre annonce possède déjà le même titre. Veuillez changer de titre"
 * )
 */
class Ad
{
    ...
    public function getNotAvailableDays(){
        ...
        foreach($this->bookings as $booking){
            //calculer les jours qui se trouvent entre date arrivée et date de départ
            $resultat = range(
            ...
            //Tableau qui contient des chaines de cracatèrees de mes journées
